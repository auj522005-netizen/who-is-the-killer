...
name: web-databases
description:
  Comprehensive guide covering Databases & Servers for web developers.
  Includes topics, resources, and learning paths with curated links.
  Use this skill when the user asks about databases & servers,
  wants to learn web development topics, or needs resource recommendations.
metadata:
  openclaw:
    emoji: "🗄️"
---
...
A comprehensive skill covering databases & servers for web developers, with curated learning resources and links.

## When to Use

- User asks about topics related to databases & servers
- User wants to learn or improve skills in databases & servers
- User needs resource recommendations or learning paths
- User mentions specific technologies within this domain
						...
						/*{
							...
							description: {
								...
								links: [
									...
									["Practical reasons behind learning relational algebra", 
...
This skill is a knowledge base. When the user asks about a topic:
1. Find the relevant section below
2. Provide the description and curated links
3. Suggest a learning path if appropriate
4. Add your own knowledge to enrich the answer
