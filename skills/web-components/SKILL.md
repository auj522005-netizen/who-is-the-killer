...
name: web-components
description:
  Comprehensive guide covering Web Components for web developers.
  Includes topics, resources, and learning paths with curated links.
  Use this skill when the user asks about web components,
...
A comprehensive skill covering web components for web developers, with curated learning resources and links.

## When to Use

- User asks about topics related to web components
- User wants to learn or improve skills in web components
