...
name: web-modern
description:
  Comprehensive guide covering The Modern Web for web developers.
  Includes topics, resources, and learning paths with curated links.
  Use this skill when the user asks about the modern web,
...
A comprehensive skill covering the modern web for web developers, with curated learning resources and links.

## When to Use

- User asks about topics related to the modern web
- User wants to learn or improve skills in the modern web
