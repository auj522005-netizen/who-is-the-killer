...
name: web-algorithms
description:
  Comprehensive guide covering Algorithms & Data structures for web developers.
  Includes topics, resources, and learning paths with curated links.
  Use this skill when the user asks about algorithms & data structures,
...
A comprehensive skill covering algorithms & data structures for web developers, with curated learning resources and links.

## When to Use

- User asks about topics related to algorithms & data structures
- User wants to learn or improve skills in algorithms & data structures
